...
#   REVESICLE_JS   -> path to the input .js
#   REVESICLE_DCD  -> path to the input .dcd
...
# Required: JS and DCD paths
if {![info exists env(REVESICLE_JS)] || ![info exists env(REVESICLE_DCD)]} {
  puts "ERROR: Missing REVESICLE_JS and/or REVESICLE_DCD environment variables."
  puts "Provide them via ReVesicle.sh command line (e.g., -js <file.js> -dcd <file.dcd>)."
  quit
}
set SYSTEM_JS $env(REVESICLE_JS)
set TRAJ_DCD  $env(REVESICLE_DCD)
...
mol new $SYSTEM_JS waitfor all
mol addfile $TRAJ_DCD type dcd waitfor all
...
$remove_water writejs STEP-1_A_empty_holes.js
$remove_water writenamdbin STEP-1_A_empty_holes.coor
