...
mol new ../STEP-1-3_B/STEP-1_B/STEP-1_B_empty_holes.js waitfor all
mol addfile ../STEP-1-3_B/STEP-3_B/STEP-3_B.dcd type dcd waitfor all
...
if { [file exists ./IN_OUT_water_holes_1.txt] == 1} {puts "Output file is present. Eliminating it.."; exec rm ./IN_OUT_water_holes.txt}
...
$remove_water writejs STEP-4_empty_holes.js
$remove_water writenamdbin STEP-4_empty_holes.coor
