...
mol addfile STEP-3_A.dcd type dcd waitfor all

set sel [atomselect top "not resname TIP3 CLA SOD"]
$sel writejs STEP-3_A_stripped.js
animate write dcd STEP-3_A_stripped.dcd beg 0 end -1 skip 1 waitfor all sel $sel top
